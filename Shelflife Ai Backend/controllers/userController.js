...
const createUser = async (req, res) => {
  try {
    ...
    const validRoles = ["Super Admin", "Admin", "Inventory Manager", "Inventory Staff"];
...
const updateUser = async (req, res) => {
  try {
    ...
    // Prevent a Super Admin from changing their own role by accident
    // (avoids accidentally locking themselves out of Super Admin access)
