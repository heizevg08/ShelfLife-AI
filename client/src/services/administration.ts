...
export const listAccounts = (page = 1, sortBy = 'createdAt', sortOrder = 'desc', signal?: AbortSignal) => apiClient<Page<Account>>(`/users?page=${page}&pageSize=25&sortBy=${encodeURIComponent(sortBy)}&sortOrder=${encodeURIComponent(sortOrder)}`, { signal });
